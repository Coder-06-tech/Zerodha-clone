...
//         newPosition.save();
//     });
//     res.send("Done!!!added position data")
// });

app.get("/allHoldings", async (req, res) => {
  let allHoldings = await HoldingsModel.find({}); //{} means fetching evrything
  res.json(allHoldings);
});

app.get("/allPositions", async (req, res) => {
  let allPositions = await PositionsModel.find({}); //{} means fetching evrything
